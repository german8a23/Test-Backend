...
//   async create(categoriaDto: CategoriaDTO): Promise<Categoria> {
//     const createdCategoria = new this.categoriaModel(categoriaDto);
//     return createdCategoria.save();
//   }
...
//   async update(id: string, categoriaDto: CategoriaDTO): Promise<Categoria> {
//     return this.categoriaModel.findByIdAndUpdate(id, categoriaDto, { new: true }).exec();
//   }

//   async deleteCategoria(id: string): Promise<Categoria> {
//     return this.categoriaModel.findByIdAndRemove(id).exec();
//     // await this.categoriaModel.findByIdAndRemove(id).exec();
//   }
