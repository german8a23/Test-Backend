...
//     const count = await this.productoModel.countDocuments().exec();
//     const crearProducto = new this.productoModel({
//       id: count + 1,
//       nombre: productoDTO.nombre,
//       stock: productoDTO.stock,
//       precio: productoDTO.precio,
...
//     productoDTO: ProductoDTO,
//   ): Promise<Producto> {
//     return this.productoModel.findByIdAndUpdate(id, productoDTO, {
//       new: true,
//     });
//   }
...
// }
  ...
  // async buscarProductosPorCategoria(categoria: string): Promise<Producto[]> {
